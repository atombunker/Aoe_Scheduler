...
class Aoe_Scheduler_Block_Adminhtml_Job_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('cron_fieldset', [
            'legend' => $this->__('Scheduling'),
        ]);
        $this->_addElementTypes($fieldset);
        ...
        $fieldset = $form->addFieldset('parameter_fieldset', [
            'legend' => $this->__('Extras'),
        ]);
        $this->_addElementTypes($fieldset);
        ...
        $fieldset = $form->addFieldset('dependency_fieldset', [
            'legend' => $this->__('Dependencies'),
        ]);
        $this->_addElementTypes($fieldset);
